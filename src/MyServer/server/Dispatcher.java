...
public class Dispatcher implements Runnable {
    ...
    Dispatcher(Socket client) {
        ...
        try {
            ...
            if (urlLen > 5) {
                ...
                }else if (url.substring(urlLen - 3, urlLen).contentEquals("png") && url.lastIndexOf(".") == urlLen - 4) {
                    rep = new Response(client.getOutputStream(), "png");
                    type = "png";
                    System.out.println("Dispatcher:init response png");
                }
            }
    ...
    public void run() {
         ...
         *
         */
        if (type.contentEquals("css") || type.contentEquals("html")
                || type.contentEquals("js")|| type.contentEquals("png")
                || type.contentEquals("ico")) {
            ...
            try {
                ...
                if (servlet == null) {
                    ...
                    if(Util.primeStatic(req.getUrl())){
                        ...
                        System.out.println("Dispacher: cannot get the static!! "+req.getUrl());
                        this.code = 404;
                    }
                }

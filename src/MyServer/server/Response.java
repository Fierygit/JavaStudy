		...
		headInfo.append("Date:").append(new Date()).append(CRLF);
		 ...
		 if(ContentType.equals("css")){
			headInfo.append("Content-type:text/css;charset=utf-8").append(CRLF);
			 ...
			 headInfo.append("Accept-Ranges: bytes").append(CRLF);
			 headInfo.append("Content-type:image/png;").append(CRLF);
		 } else if(ContentType.equals("js")){
			headInfo.append("Content-type:text/js;charset=utf-8").append(CRLF);
		}else  if(ContentType.equals("ico")){
			headInfo.append("Content-type:image/ico;charset=utf-8").append(CRLF);
		} else{
